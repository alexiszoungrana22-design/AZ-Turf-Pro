...
# Fonction pour chercher dynamiquement le vrai lien PDF dans la page LONAB
    ...
    try:
        async with httpx.AsyncClient(verify=False) as client:
            ...
            for lien in soup.find_all('a', href=True):
                ...
                # Vérifie si c'est un PDF et s'il correspond au document recherché
...
async def get_bruits_ecurie():
    # Lecture des vrais bruits depuis le fichier de la base de données locale
    ...
    # Message de secours si le fichier n'est pas encore rempli
